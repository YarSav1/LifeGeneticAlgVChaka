...
SIZE_UNIT = 15  # размер юнитов в пикселях
# RADIUS_UNIT = 6  # радиус у юнита во сколько раз от его размера
LEN_LIFE = 36 # Продолжительность жизни юнита в месяцах
...
FOOD_FOR_PLUS_LIFE = 50 # сколько нужно еды, чтобы продлить себе жизнь<=================\/
PLUS_LIFE_AFTER = 120 # сколько МЕСЯЦЕВ жизни будет давать еда при использовании умения ВЫШЕ

FOOD_FOR_DUPLICATE = 30  # сколько нужно съесть еды(в энергии) чтобы размножиться
CHANCE_MUTATION = 1  # вероятность мутации в процентах. МАКСИМУМ 100
