...
SIZE_UNIT = 7  # размер юнитов в пикселях
# RADIUS_UNIT = 6  # радиус у юнита во сколько раз от его размера
LEN_LIFE = 360  # Продолжительность жизни юнита в месяцах
STARVING = -50  # до какой степени юнит может голодать, прежде чем умрет

ONE_YEAR = 30  # число обработок равному 1 игровому году.

ENERGY_FOOD = 30  # сколько энергии будет давать 1 еда
SIZE_FOOD = 3
